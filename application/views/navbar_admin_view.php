    ...
    <nav class="green">
      <div class="nav-container nav-wrapper">
        ...
        <ul class="right hide-on-med-and-down">
          <li><a class="tooltipped" data-position="bottom" data-delay="50" data-tooltip="Search books or user" href="<?php echo base_url('index.php/pencarian/buku') ?>"><i class="lime-text text-lighten-5 mdi-action-search"></i></a></li>
