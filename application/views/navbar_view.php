<div class="header_wrapper"> <!-- end div ini ada di masing-masing view of reqin, reqout, coll, dan wishlist-->
    <ul id="dropdown1" class="dropdown-content dropdown-content-custom">
      ...
      echo base_url()."index.php/Profile/showProfile/".$username?>"><span class="green-text">My Profile</span></a></li>
      <li class="divider"></li>
    ...
    <nav class="green">
      <div class="nav-container nav-wrapper">
        ...
        <ul class="right hide-on-med-and-down">
          ...
          <li><a class="tooltipped" data-position="bottom" data-delay="50" data-tooltip="Notifications" href="<?php echo base_url('index.php/Notification/') ?>"><i class="lime-text text-lighten-5 mdi-social-notifications" id="notif-icon"></i></a></li>
