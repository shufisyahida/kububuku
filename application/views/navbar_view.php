    ...
    <nav class="green">
      <div class="nav-container nav-wrapper">
        ...
        <ul class="right hide-on-med-and-down">
          ...
          <li><a class="tooltipped" data-position="bottom" data-delay="50" data-tooltip="Notifications" href="<?php echo base_url('index.php/Notification/') ?>"><i class="lime-text text-lighten-5 mdi-social-notifications"></i></a></li>
