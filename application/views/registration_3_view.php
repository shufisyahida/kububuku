...
<div class="container" style="margin-top:50px;">
    ...
    <form method="post" action="<?php echo base_url('pendaftaran/daftar3') ?>">
        <div>
            <div class="card-panel z-depth-1">
                ...
                <div class="langkah">                     
                    <div class="steps">
                        ...
                        <div class="step step3 aktip">3</div>
                ...
                <div class="row langkah3">
                    <p>Kontak ini digunakan sebagai sarana komunikasi peminjam dan pemilik buku</p>
