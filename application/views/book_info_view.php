...
<div class="container custom-table">
    <div id="modal-report" class="modal">
        ...
        <div class="modal-footer">
            ...
            <a href="<?php echo base_url()."index.php/Request/createDeleteRequest/".$resultBook[0]->isbn?>" class="waves-effect waves-green btn-flat modal-action">Laporkan</a>
        </div>
    </div>
...
echo '
      <div id="modal-addcol" class="modal">
        ...
        <div class="modal-footer">
          ...
          <a href="'.base_url()."index.php/koleksi/tambah/".$resultBook[0]->isbn."/".$username.'"
  ...
  echo '
      <div id="modal-wishlist" class="modal">
        ...
        <div class="modal-footer">
          ...
          <a href="'.base_url()."index.php/Wishlist/tambah/".$resultBook[0]->isbn.'"
            class="waves-effect waves-green btn-flat modal-action">ADD</a>
        </div>
      </div>
      ';
...
<?php
  ...
  echo '
            ...
            <a href="'.base_url().'index.php/Request/showUpdateBook/'.$resultBook[0]->isbn.'" class="waves-effect waves-light btn-floating green right-align z-depth-1 tooltipped" data-position="top" data-delay="10" data-tooltip="Perbarui buku ini"><i class="mdi-editor-mode-edit"></i></a>
        ';}?>
        </div>
      </div>
    </div>
              ...
              <div align="right">
                ...
                <?php foreach($resultOwner as $row){?>
                  ...
                  '<div class=" right col s4 m4 l4">
                    <a href = "'.base_url()."index.php/profil/lihatProfil/".$row->username.'" >
                ...
                <div class="row">
                  ...
                  <?php
                    ...
                    echo '<a class="waves-effect waves-green btn-flat" href="'.base_url()."index.php/buku/pemilik/".$isbn.'">Selengkapnya...</a>';
                  }
                  else
                  {
                    echo '<h5>No Owner</h5>'; 
