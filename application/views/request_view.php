				  	...
				  	foreach($deleteRequest as $key => $post){?>
						<li class="collection-item avatar">
							...
							<div id="modal-acceptRemove<?php echo $post->id?>" class="modal">
								...
								<a href="#modal-acceptRemove<?php echo $post->id?>" class="secondary-content modal-trigger"><i class="mdi-action-done green-text small"></i></a>
								<a href="#modal-acceptRemove<?php echo $post->id?>" class="secondary-content-2 modal-trigger"><i class="mdi-content-clear red-text small"></i></a>
							</div>
						</li>
					<?php }}
					else
			  	...
			  	foreach($updateRequest as $key => $post){?>
					<li class="collection-item avatar">
						<div>
							...
							<a href="#modal-acceptUpdate<?php echo $post->id?>" class="secondary-content modal-trigger"><i class="mdi-action-done green-text small"></i></a>
							<a href="#modal-declineUpdate<?php echo $post->id?>" class="secondary-content-2 modal-trigger"><i class="mdi-content-clear red-text small"></i></a>
